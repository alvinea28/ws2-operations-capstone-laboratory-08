...
Monitor. No invented Monitor AVM, Bicep or Sentinel. Finish [offline handover](../.github/steps/04.md) first.
...
Use [your Azure guide values](azure-setup.md). Confirm the existing RG,
...
triage, not an invented outage. Follow [Git steps](git-workflow.md): branch
...
Follow the [cleanup/privacy boundary](azure-setup.md#7-cleanup-privacy-and-returning-to-the-exercise):
